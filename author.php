...
<body>
    ...
    <div class="row">
			<div class="col m12">
				<div class="mysearch" style = "padding-bottom = 30px">Results By Selected Author</div>
			</div>
...
$myauthor = $_GET['filter'];
//API BEING IMPLEMENTED
$endpoint = "http://jwalsh33.lampt.eeecs.qub.ac.uk/projectAPI/proapi.php?author=$myauthor&apikey=42a60a84579dbdfcf70369ca7aa2ba7a";
