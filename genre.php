...
<body>
    ...
    <div class="row">
			<div class="col m12">
				<div class="mysearch" style = "padding-bottom = 30px">Results By Selected Genre</div>
			</div>
...
$endpoint = "http://jwalsh33.lampt.eeecs.qub.ac.uk/projectAPI/proapi.php?genre=$mygenre&apikey=42a60a84579dbdfcf70369ca7aa2ba7a";
