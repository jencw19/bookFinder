...
<body>
	...
	<div class="row">
			<div class="col m12">
				<div class="mysearch" style = "padding-bottom = 30px">Results By Selected Age</div>
			</div>
...
$endpoint = "http://jwalsh33.lampt.eeecs.qub.ac.uk/projectAPI/proapi.php?age=$myage1&apikey=42a60a84579dbdfcf70369ca7aa2ba7a";
...
if(empty($data)){
	...
	foreach($data as $row){
	 ...
	 //echo"<img src=$imgendpoint alt = 'https://via.placeholder.com/400.png/09f/fff'>";
