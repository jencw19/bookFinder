...
<body>
	...
	<div class="row">
			<div class="col m12">
				<div class="mysearch" style = "padding-bottom = 30px">Trending</div>
			</div>
		</div>
...
$endpoint = "http://jwalsh33.lampt.eeecs.qub.ac.uk/projectAPI/proapi.php?trending&apikey=42a60a84579dbdfcf70369ca7aa2ba7a";
